...
export function FoundationPage({ environment, health }: FoundationPageProps) {
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl items-center px-6 py-16">
      ...
      >
        <p className="text-sm font-semibold uppercase tracking-wider text-blue-700">CTPS</p>
        <h1
          id="foundation-title"
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-slate-700">
          The repository foundation is active. Public business features are not implemented yet.
        </p>
