...
const allowed =
  /^(users(?:\/[0-9a-f-]+(?:\/(?:roles|disable|reactivate|reset-password))?)?|roles(?:\/[0-9a-f-]+(?:\/permissions)?)?|before-after-projects(?:\/[0-9a-f-]+(?:\/(?:media-order|publish|unpublish|archive))?)?|media\/before-after\/[0-9a-f-]+)$/i;
